...
public class JLAuthorizationManager: NSObject {
    
    public static let shared = JLAuthorizationManager()
    ...
    public func authorizedStatus(_ type: PermissionType) -> AuthorizedStatus {
